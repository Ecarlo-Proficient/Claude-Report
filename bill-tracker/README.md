...
memo says so, memo-gated not a blanket pass; the memo is read per BILL - the pea-gravel line, the
bill memo, or a sibling line vouches for the bill's surcharge / environmental / tax lines), **material** (e.g. RCI → `*2/*3/*4`, never `*1`/`*5`/`*6`), **both**
